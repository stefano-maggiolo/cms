...
goog.provide('aws.directives');
goog.provide('aws.directives.module');



aws.directives.module = angular.module('aws.directives', [], function() {});


aws.directives.module.directive('ngDatetime', [function () {
...
aws.directives.module.directive('file', function() {
    var directiveDefinitionObject = {
        restrict: 'E',
