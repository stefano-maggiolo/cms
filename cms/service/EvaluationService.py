...
from .esoperations import ESOperation, submission_get_operations, \
...
class EvaluationService(Service):
    ...
    def get_submission_operations(self, submission):
        """Return the operations required by a submission.
    ...
    def get_user_test_operations(self, user_test):
        """Return the operations required by a user test.
    ...
    def write_result(self, operation, job):
        ...
        with SessionGen() as session:
            ...
            if type_ == ESOperation.COMPILATION:
                ...
                new_operations = self.user_test_evaluation_ended(
                    object_result)
